...
\section{DFS algorithms}
	\kactlimport{SCC.h}	\kactlimport{BiconnectedComponents.h}
	\kactlimport{2sat.h}	\kactlimport{BridgesAndArticulation.h}
...
\section{Trees}
    ...
    \kactlimport{ReachabilityTree.h}
...
\section{Math}
	\subsection{Number of Spanning Trees}
		...
		(if $G$ is undirected, remove any row/column).\linebreak
